(function () {
  var GatesGame = {
    ...
    run: function () {
      this.setAwardGate(this.getRandomGate());
      this.setPlayersGate(this.getRandomGate());
      this.rejectGates(this.hostRejectsAllButTwo());
      this.setPlayersGate(this.playerMakesDecision());
    },

    result: function () {
      return this.getAwardGate() === this.getPlayersGate();
    },
